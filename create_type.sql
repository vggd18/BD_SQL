...
/
CONSTRUCTOR FUNCTION CONSTRUCTOR_IF (CNPJ VARCHAR2(14), NOME VARCHAR2(40), SETOR VARCHAR2(8)) RETURN SELF AS RESULT IS 
    BEGIN
        SELF.CNPJ := CNPJ;
        SEF.NOME := NOME,
        SELF.SETOR := SETOR;
...
DECLARE 
    CONST TP_INSTITUICAO_FINANCEIRA
begin
  CONST := ('01111111111111','VITOLAS BANK','PUBLICO')
end; 
