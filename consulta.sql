...
-- SELECIONA O NOME DOS ENGENHEIROS COM ESPECIALIZACAO EM ALGUMA ÁREA CIVIL
SELECT F.NOME, E.CPF_ENGENHEIRO
FROM ENGENHEIRO E
JOIN FUNCIONARIO F ON E.CPF_ENGENHEIRO = F.CPF_FUNCIONARIO
WHERE CPF_ENGENHEIRO =      (SELECT CPF_ENGENHEIRO FROM ESPECIALIZACAO WHERE ESPECIALIZACAO LIKE 'CIVIL%')
