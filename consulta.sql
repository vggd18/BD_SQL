...
-- listar elementos do varray telefones
SELECT f.CNPJ_FORNECEDOR, t.COLUMN_VALUE AS TELEFONE
FROM TB_FORNECEDOR f, TABLE(f.TELEFONE) t
WHERE f.CNPJ_FORNECEDOR = '73456789012345'; 
