...
INSERT INTO TB_PROJETO VALUES ('PROJ1', (SELECT REF(e) FROM TB_ENGENHEIRO e WHERE e.CPF = '04444444401'), (SELECT REF(c) FROM TB_CLIENTE c WHERE c.CNPJ_C = '2098765432109'), (SELECT REF(i) FROM TB_INSTITUICAO_FINANCEIRA i WHERE i.CNPJ_INSTITUICAO = '54444444444444'));
INSERT INTO TB_PROJETO VALUES ('PROJ2', (SELECT REF(e) FROM TB_ENGENHEIRO e WHERE e.CPF = '04444444402'), (SELECT REF(c) FROM TB_CLIENTE c WHERE c.CNPJ_C = '2098765432109'), (SELECT REF(i) FROM TB_INSTITUICAO_FINANCEIRA i WHERE i.CNPJ_INSTITUICAO = '54444444444444'));
INSERT INTO TB_PROJETO VALUES ('PROJ3', (SELECT REF(e) FROM TB_ENGENHEIRO e WHERE e.CPF = '04444444403'), (SELECT REF(c) FROM TB_CLIENTE c WHERE c.CNPJ_C = '2098765432109'), (SELECT REF(i) FROM TB_INSTITUICAO_FINANCEIRA i WHERE i.CNPJ_INSTITUICAO = '54444444444444'));
INSERT INTO TB_PROJETO VALUES ('PROJ4', (SELECT REF(e) FROM TB_ENGENHEIRO e WHERE e.CPF = '04444444404'), (SELECT REF(c) FROM TB_CLIENTE c WHERE c.CNPJ_C = '2210987654321'), (SELECT REF(i) FROM TB_INSTITUICAO_FINANCEIRA i WHERE i.CNPJ_INSTITUICAO = '54444444444444'));
INSERT INTO TB_PROJETO VALUES ('PROJ5', (SELECT REF(e) FROM TB_ENGENHEIRO e WHERE e.CPF = '04444444405'), (SELECT REF(c) FROM TB_CLIENTE c WHERE c.CNPJ_C = '2210987654321'), (SELECT REF(i) FROM TB_INSTITUICAO_FINANCEIRA i WHERE i.CNPJ_INSTITUICAO = '54444444444444'));
